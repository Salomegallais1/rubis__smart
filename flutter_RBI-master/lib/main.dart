...
class _HomeState extends State<Home> {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            FutureBuilder(
              future: getData(
                  'SELECT DISTINCT "test" as Code_CM, CONCAT(Code_CM," - ",nom_mag) as Code_CM FROM magasin WHERE OuvertFerme = 0 ORDER BY nom_mag',
                  'Code_CM'),
  ...
  void uploadFile(id, filePath) async {
    ...
    if(id == null && _selectMagasin != null && _selectTheme != null && filePath != null) { //Saisie
    ...
    } else if(_selectMagasin != null && _selectTheme != null) { // Modif
      if(filePath!=null){
        String fileName = "fdvrbs_"+basename(filePath.path);
        try {
          FormData formData = FormData.fromMap({
